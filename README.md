Dead simple calorie tracker, saves data locally/personal icloud. No ads, no tracking. Single html page.

Hosted on github pages: https://farisjarrah.github.io/calorie-tracker/

Or just open the index.html in a webpage.

For people that dont need fancy features or that dont want to download an app just to do basic things.

If you save your file to icloud storage you can use the same file for all of your devices.

WARNING: This was vibecoded using the free OpenCode Big Pickle AI Model 08/2026.
